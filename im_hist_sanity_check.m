...
if ~(isequal(h1d,h3dslowplot)),
  disp('h1d ~= h3dslow');
  draw3hist(hist_diff(h1d,h3dslowplot),'error between alpha\_hist and im\_hist\_cube');
end
if ~(isequal(h1d,h3dfastplot)),
  disp('h1d ~= h3dfast');
  draw3hist(hist_diff(h1d,h3dfastplot),'error between alpha\_hist and im\_hist\_cube\_fast');
end
if ~(isequal(h3dfast,h3dslow)),
  disp('h3dfast ~= h3dslow');
  draw3hist(hist_diff(h3dfastplot,h3dslowplot),['error between im\_hist\_cube and ' ...
